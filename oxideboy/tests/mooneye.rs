...
acceptance_test_cases! {
    ...
    boot_div_dmg_abc_mgb:               "boot_div-dmgABCmgb",               Model::DMGABC, false,
    boot_div_dmg_abc_mgb_realbootrom:   "boot_div-dmgABCmgb",               Model::DMGABC, true,
    boot_hwio_dmg0:                     "boot_hwio-dmg0",                   Model::DMG0, false,
    boot_hwio_dmg0_realbootrom:         "boot_hwio-dmg0",                   Model::DMG0, true,
    boot_hwio_dmg_abc_mgb:              "boot_hwio-dmgABCmgb",              Model::DMGABC, false,
    boot_hwio_dmg_abc_mgb_realbootrom:  "boot_hwio-dmgABCmgb",              Model::DMGABC, true,
