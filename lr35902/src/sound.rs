...
impl SoundController {
    ...
    pub fn write_nr34(&mut self, v: u8) {
        ...
        self.sound3_init    = v & 0b1000_0000 > 0;
    }
    ...
    pub fn read_nr51(&self) -> u8 {
        ...
        0
            | if self.sound1_left  { 0b0000_0001 } else { 0 }
            | if self.sound2_left  { 0b0000_0010 } else { 0 }
            | if self.sound3_left  { 0b0000_0100 } else { 0 }
            | if self.sound4_left  { 0b0000_1000 } else { 0 }
            | if self.sound1_right { 0b0001_0000 } else { 0 }
            | if self.sound2_right { 0b0010_0000 } else { 0 }
            | if self.sound3_right { 0b0100_0000 } else { 0 }
            | if self.sound4_right { 0b1000_0000 } else { 0 }
    }
    ...
    pub fn write_nr51(&mut self, v: u8) {
        ...
        self.sound1_left  = v & 0b0000_0001 > 0;
        self.sound2_left  = v & 0b0000_0010 > 0;
        self.sound3_left  = v & 0b0000_0100 > 0;
        self.sound4_left  = v & 0b0000_1000 > 0;
        self.sound1_right = v & 0b0001_0000 > 0;
        self.sound2_right = v & 0b0010_0000 > 0;
        self.sound3_right = v & 0b0100_0000 > 0;
        self.sound4_right = v & 0b1000_0000 > 0;
    }
